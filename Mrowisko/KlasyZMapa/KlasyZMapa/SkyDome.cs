...
namespace Map
{
    public class SkyDome
    {
        ...
        public void DrawSkyDome(FreeCamera camera)
        {
            ...
            Matrix wMatrix = Matrix.CreateTranslation(0, -0.8f, 0) * Matrix.CreateScale(1000) * Matrix.CreateFromYawPitchRoll(camera.Yaw, camera.Pitch, 0) * Matrix.CreateTranslation(camera.Position);
