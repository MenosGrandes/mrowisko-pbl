...
namespace Map
{
    public class SkyDome
    {
        ...
        public void DrawSkyDome(FreeCamera camera)
        {
            ...
            Matrix wMatrix = Matrix.CreateTranslation(0, -0.1f, 0) * Matrix.CreateScale(100) * Matrix.CreateFromYawPitchRoll(MathHelper.ToRadians(0), camera.Pitch, 0);//* Matrix.CreateTranslation(camera.Position);
